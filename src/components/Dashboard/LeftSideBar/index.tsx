...
import { RecommendIcon } from "../../../../public/assets/icons/RecommendIcon";
        ...
        <>
            ...
            <LeftSideContainer className={menuState ? 'open' : ''}>
                <LeftSideBarWrapper>
                    ...
                    <LeftSideBarListItem href="/courses"
                    ...
                    <LeftSideBarListItem href="/books"
                    ...
                    <LeftSideBarListItem href="/recommendation"
                        className={router.pathname == "/recommendation" ? "active" : ""}
                    >
                        <LeftSideBarIcon>
                            <RecommendIcon />
                        </LeftSideBarIcon>
                    ...
                    <LeftSideBarListItem href="/messages/maguyva" className={router.pathname == "/messages/[username]" ? "active" : ""}>
                        <LeftSideBarIcon>
                            <ChatIcon />
                        </LeftSideBarIcon>
                        {/* <LeftSideBarIcon>
                    ...
                    <LeftSideBarListItem href="/forum" className={router.pathname == "/forum" ? "active" : ""}>
                        {/* <LeftSideBarIcon>
                    </LeftSideBarIcon> */}
                        <LeftSideBarIcon>
                            <MdForum />
                    ...
                    <LeftSideBarListItem href="/notifications" className={router.pathname == "/notifications" ? "active" : ""}>
                        <LeftSideBarIcon>
                            <NotiIcon />
                        </LeftSideBarIcon>
                        {/* <LeftSideBarIcon>
                    ...
                    <LeftSideBarListItem href="/support" className={router.pathname == "/support" ? "active" : ""}>
                        <LeftSideBarIcon>
                            <SupportIcon />
                        </LeftSideBarIcon>
                        {/* <LeftSideBarIcon>
                    ...
                    <LeftSideBarListItem href="/admin" className={router.pathname == "/admin" ? "active" : ""}>
                        <LeftSideBarIcon>
                            <AdminIcon />
                        </LeftSideBarIcon>
                        {/* <LeftSideBarIcon>
